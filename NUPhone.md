...
H&T uses a similarity paradigm. Rolling up a similarity score for a word, based upon the similarity of its components is altogether intuitive. Even Bing seems to be in accord. Stay tuned for source code. Coding will be Rust or C++.
